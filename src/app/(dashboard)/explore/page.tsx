...
export default function ExplorePage() {
  ...
  const SearchDropdown = () => (
    <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50">
      <div className="p-4 border-b border-white/5">
        ...
        {heroes.slice(0,2).map(u => (
          <div key={u.id} className="flex items-center gap-3 mb-3 cursor-pointer hover:bg-slate-100 dark:bg-zinc-800 p-2 rounded-xl transition-colors" onClick={() => router.push(`/profile/${u.username}`)}>
             <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-zinc-800 flex-shrink-0 overflow-hidden">
                        ...
                        <div key={i} className="bg-slate-50 dark:bg-zinc-950 border border-white/5 rounded-2xl p-5 hover:border-blue-500/30 transition-colors cursor-pointer group">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-slate-500 dark:text-zinc-500">Official • {500 + i * 150} members</div>
                            </div>
                          </div>
