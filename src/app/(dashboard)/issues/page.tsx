    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 dark:text-zinc-400">Discover and support civic issues reported in your city.</p>
        </div>
        ...
        <div className="flex w-full md:w-auto items-center gap-2">
          <div className="relative w-full md:w-80">
            ...
            <Input 
              ...
              className="pl-10 bg-white dark:bg-zinc-900 border-white/10"
            />
          </div>
          <Button 
            variant="outline" 
            onClick={() => setShowFilters(!showFilters)}
            className={cn("border-white/10 shrink-0", showFilters ? "bg-primary/20 text-primary border-primary/30" : "bg-white dark:bg-zinc-900")}
          >
      ...
      <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar pb-2 mb-6">
        {[
          { id: "All", label: "All Issues", color: "bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-300" },
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected ? chip.color.split(' ')[0].replace('/10', '/20') + " " + chip.color.split(' ')[1] + " shadow-lg" : "bg-white dark:bg-zinc-900 text-slate-500 dark:text-zinc-400 hover:bg-slate-100 dark:bg-zinc-800"
              )}
            >
              {isSelected && (
                <motion.div
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        {showFilters && (
          <Card className="hidden lg:block w-64 shrink-0 p-5 bg-white dark:bg-zinc-900/50 border-white/5 space-y-6 sticky top-6">
                ...
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      sortBy === s.id ? "bg-primary/20 text-primary font-medium" : "text-slate-500 dark:text-zinc-400 hover:bg-slate-100 dark:bg-zinc-800"
                    )}
                  >
                    {s.label}
                  </button>
        ...
        <div className="flex-1 w-full">
          {loading ? (
            ...
            <EmptyState
              ...
              description="Try adjusting your search queries or clearing the filters to see more results."
              action={
                <Button 
                  variant="outline" 
                  className="mt-2"
